    ...
    <div className="space-y-6 text-neutral-200 font-sans max-w-7xl mx-auto pb-16">
      ...
      <div className="p-6 rounded-2xl bg-[#0e0e0e] border border-neutral-800 space-y-2">
        <div className="flex items-center gap-2 text-neutral-300 font-bold text-xs">
          <Calculator className="w-4 h-4 text-white" /> CALCULADORA SIMULADORA DE EXPANSÃO SAAS & AGÊNCIA
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Controls Column */}
        <div className="lg:col-span-5 p-6 rounded-2xl bg-[#0e0e0e] border border-neutral-800 space-y-5">
          <h3 className="font-extrabold text-white text-sm border-b border-neutral-800 pb-3">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-neutral-300">Ticket Médio Mensal por Cliente</span>
                <span className="text-white">R$ {ticketMedio.toLocaleString('pt-BR')}</span>
              </div>
              <input
                type="range"
                min="500"
                ...
                className="w-full accent-white bg-neutral-900 h-2 rounded-lg"
              />
            </div>
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-neutral-300">Meta de Faturamento Mensal (MRR)</span>
                <span className="text-white">R$ {targetRevenue.toLocaleString('pt-BR')}</span>
              </div>
              <input
                type="range"
                min="5000"
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-neutral-300">Taxa de Conversão da Equipe (%)</span>
                <span className="text-white">{metaConversionRate}%</span>
              </div>
              <input
                type="range"
                min="1"
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-neutral-300">Custo Por Lead Médio (CPL)</span>
                <span className="text-white">R$ {cpl}</span>
              </div>
              <input
                type="range"
                min="5"
            ...
            <div>
              <div className="flex justify-between font-bold mb-1">
                <span className="text-neutral-300">Permanência Média do Cliente</span>
                <span className="text-white">{avgRetentionMonths} meses</span>
              </div>
              <input
                type="range"
                min="3"
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl bg-[#0e0e0e] border border-neutral-800 space-y-2">
              ...
              <p className="text-[10px] text-neutral-500">Para atingir a meta de MRR</p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#0e0e0e] border border-neutral-800 space-y-2">
              ...
              <div className="text-3xl font-black text-white">{totalLeadsNeeded} leads</div>
            ...
            <div className="p-5 rounded-2xl bg-[#0e0e0e] border border-neutral-800 space-y-2">
              ...
              <p className="text-[10px] text-neutral-500">Verba estimada para compra de tráfego</p>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#0e0e0e] border border-neutral-800 space-y-2">
              ...
              <p className="text-[10px] text-neutral-500">Valor gerado por cliente ao longo do contrato</p>
            </div>
          </div>

          {/* LTV/CAC Card */}
          <div className="p-6 rounded-2xl bg-[#0e0e0e] border border-neutral-700 space-y-3 shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-xs font-extrabold text-neutral-300 uppercase">
                  Relação LTV / CAC Projetada
                </span>
                <h4 className="text-2xl font-black text-white">{ltvCacRatio} : 1</h4>
              </div>
              <div className="text-right">
                <span className="text-xs font-bold text-neutral-400">CAC Estimado</span>
